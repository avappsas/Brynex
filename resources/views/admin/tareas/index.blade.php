...
<div class="tar-wrap" style="flex: 1; min-height: 0; display: flex; flex-direction: column; gap: 0.4rem; overflow: hidden;">
    ...
    <div class="filtros-bar" style="display:flex; gap:0.4rem; flex-wrap:wrap; align-items:center; background:#fff; border:1px solid #e2e8f0; border-radius:12px; padding:0.4rem 0.8rem; margin-bottom:0.1rem;">
        ...
        {{-- Empresa del cliente: se escribe parte del nombre y se elige de la
             lista. Solo aparecen empresas que tienen clientes con tareas. --}}
        @php $empresaSel = $empresasDisponibles->firstWhere('id', request('empresa_id')); @endphp
        <div id="empresaBox" style="position:relative;">
            ...
            <input type="text" id="empresaBuscar" autocomplete="off"
                   ...
                   placeholder="🏢 Empresa..."
                   style="width:190px; padding:0.3rem 0.5rem; font-size:0.75rem; height:28px; box-sizing:border-box;">
            <div id="empresaLista" style="display:none; position:absolute; z-index:60; top:30px; left:0; min-width:260px; max-height:240px; overflow-y:auto; background:#fff; border:1px solid #e2e8f0; border-radius:8px; box-shadow:0 6px 18px rgba(15,23,42,.12);">
                ...
                @foreach($empresasDisponibles as $e)
...
// ── Filtro de empresa (buscador tipo select) ────────────────────────────────
(function () {
