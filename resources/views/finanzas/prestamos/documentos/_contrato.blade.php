...
<p>Sobre el <strong>saldo insoluto de capital</strong> EL MUTUARIO reconocerá y pagará a EL MUTUANTE intereses remuneratorios a la tasa del {{ $tasaLetras }} MENSUAL. Los intereses se liquidan <strong>por días transcurridos</strong>, tomando el mes de treinta (30) días, de manera que cada abono a capital reduce proporcionalmente el interés del período siguiente. El corte mensual se produce el día {{ $exp->dia_cobro }} de cada mes, siendo el primer corte el {{ $primerCorteLargo }}.</p>
...
<p>Serán de cargo de EL MUTUARIO{{ $exp->tiene_codeudor ? ' y de EL CODEUDOR SOLIDARIO' : '' }} todos los gastos de cobranza prejudicial y judicial en que deba incurrir EL MUTUANTE, incluidos los honorarios de abogado, <strong>efectivamente causados y acreditados, sin que excedan el veinte por ciento (20%) del valor total de la obligación exigible</strong>, y sin perjuicio de la liquidación de costas y agencias en derecho que efectúe el juez.</p>
