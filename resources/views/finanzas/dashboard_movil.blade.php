    ...
    <div class="app-container">
        ...
        <div x-show="activeTab === 'inicio'">
            ...
            <div class="glass-card" style="width: 100%;">
                ...
                <p style="font-size: 0.62rem; color: var(--texto-secundario); margin-bottom: 0.6rem;">Prestar e invertir no son salidas; del préstamo solo entra el interés cobrado.</p>
