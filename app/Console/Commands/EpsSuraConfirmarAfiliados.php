...
class EpsSuraConfirmarAfiliados extends Command
{
    ...
    public function handle(EpsSuraConfirmacionService $servicio): int
    {
        ...
        // `no_aparece` también: un OK a mano que Sura no tiene merece que alguien lo mire.
        ...
        $this->info(sprintf('%s%d confirmados · %d no aparecen · %d por revisar · %d errores · %d omitidos sin usuario o sin acceso a la EPS (de %d en %d empresas, %ss).',
